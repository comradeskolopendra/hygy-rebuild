import styles from "./full-article-second.module.css";
        ...
        <Layout isNeedFooter={true} isNeedHeader={true}>
            <section className={styles.contents}>
                ...
                <section className={styles.topImages}>
                    ...
                    <img className={styles.hygySecond} src={HygySecond} alt=""/>
                    <img className={styles.hygyThird} src={HygyThird} alt=""/>
                </section>
...
export default FullArticleSecondPage;